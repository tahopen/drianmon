...
"%_PENTAHO_JAVA%" -Xms1024m -Xmx2048m %JAVA_ADD_OPENS% %JAVA_LOCALE_COMPAT% -cp "%CP%" -Dlog4j.configurationFile=file:///%ROOT%\.schemaWorkbench\log4j2.xml drianmon.gui.Workbench
