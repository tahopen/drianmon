...
public class Workbench extends javax.swing.JFrame {
            ...
            .getComponent(0) instanceof SchemaExplorer)
        {
            ...
            java.io.File suggSchemaFile = new File(
                schemaFile == null
                    ...
                    : schemaFile.getName());
            DrianmonGuiDef.Schema schema = se.getSchema();
     ...
     */
    private boolean isSchemaValid(DrianmonGuiDef.Schema schema) {
        try {
            ...
            new DrianmonGuiDef.Schema(xmlParser.parse(reader));
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                ...
                w.getResourceConverter().getFormattedString(
                    ...
                    "Tahopen Schema Workbench has encountered an unrecoverable error. \n{0}",
                    ex.getLocalizedMessage()),
