...
public class PropertyTableModel extends javax.swing.table.AbstractTableModel {
    ...
    public boolean isCellEditable(int row, int col) {
        if (col == 1) {
            ...
            if (cellObj instanceof DrianmonGuiDef.Join) {
                return false;
            } else {
                return true;
            }
...
//            } else if ((target instanceof DrianmonGuiDef.UserDefinedFunction)
//                && (pName.equals("script")))
//            {
//                ((DrianmonGuiDef.UserDefinedFunction) target).script =
//                    (DrianmonGuiDef.Script) value;
//            } else if ((target instanceof DrianmonGuiDef.MemberFormatter)
//                && (pName.equals("script")))
//            {
//                ((DrianmonGuiDef.MemberFormatter) target).script =
//                    (DrianmonGuiDef.Script) value;
//            } else if ((target instanceof DrianmonGuiDef.CellFormatter)
//                && (pName.equals("script")))
//            {
//                ((DrianmonGuiDef.CellFormatter) target).script =
//                    (DrianmonGuiDef.Script) value;
//            } else if ((target instanceof DrianmonGuiDef.PropertyFormatter)
//                && (pName.equals("script")))
//            {
//                ((DrianmonGuiDef.PropertyFormatter) target).script =
//                    (DrianmonGuiDef.Script) value;

            } else if ((target instanceof DrianmonGuiDef.Level)
                && (pName.equals("ordinalExp")))
            {
                ((DrianmonGuiDef.Level) target).ordinalExp.expressions[0] =
                    (DrianmonGuiDef.SQL) value;
            } else if ((target instanceof DrianmonGuiDef.Level)
                && (pName.equals("captionExp")))
            {
                ((DrianmonGuiDef.Level) target).captionExp.expressions[0] =
                    (DrianmonGuiDef.SQL) value;
            } else if ((target instanceof DrianmonGuiDef.Table
                        && pName.equals("name"))
                       || (target instanceof DrianmonGuiDef.Hierarchy
                           && pName.equals("primaryKeyTable"))
                       || (target instanceof DrianmonGuiDef.Level
                           && pName.equals("table")))
            {
                ...
                if (value != null) {
                    ...
                    if (aValues.length == 2) {
                        if (target instanceof DrianmonGuiDef.Table) {
                            ((DrianmonGuiDef.Table) target).name = aValues[1];
                            ((DrianmonGuiDef.Table) target).schema = aValues[0];
            ...
            } else if ((target instanceof DrianmonGuiDef.Dimension
                        && pName.equals("foreignKey"))
                       || (target instanceof DrianmonGuiDef.DimensionUsage
                           && pName.equals("foreignKey"))
                       || (target instanceof DrianmonGuiDef.Measure
                           && pName.equals("column"))
                       || (target instanceof DrianmonGuiDef.Hierarchy
                       ...
                       || (target instanceof DrianmonGuiDef.Closure
                           && pName.equals("parentColumn"))
                       || (target instanceof DrianmonGuiDef.Closure
                           && pName.equals("childColumn"))
                       || (target instanceof DrianmonGuiDef.Property
                           && pName.equals("column")))
            {
                ...
                if (propertyNames[rowIndex].equals("name")
                    && (!(target instanceof DrianmonGuiDef.Table))
                    && (!value.equals(
                        target.getClass().getField(
