...
import drianmon.spi.DialectFactory;

/**
 * Implementation of {@link drianmon.spi.DialectFactory} for subclasses
 * of {@link drianmon.spi.impl.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link drianmon.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
