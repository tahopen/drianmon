...
import drianmon.spi.impl.JdbcDialectFactory;
import drianmon.spi.impl.JdbcDialectImpl;
import drianmon.util.ClassResolver;
import drianmon.util.ServiceDiscovery;

/**
 * Manages {@link drianmon.spi.Dialect} and {@link drianmon.spi.DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link drianmon.spi.DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link drianmon.util.ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
    ...
    /**
     * Implementation of {@link drianmon.spi.DialectFactory} that caches
     * dialects based on data source.
     *
     * @see drianmon.spi.Dialect#allowsDialectSharing()
     */
