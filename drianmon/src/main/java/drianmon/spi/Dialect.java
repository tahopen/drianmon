...
import drianmon.rolap.SqlStatement;
 ...
 * {@link drianmon.spi.DialectFactory} for more details.</p>
 *
 * <h3>Registering dialects</h3>
 *
 * <p>A dialect needs to be registered with the system in order to be used.
 * Call {@link drianmon.spi.DialectManager#register(DialectFactory)}
 * to register a dialect factory, or
 * {@link drianmon.spi.DialectManager#register(Class)} to register a dialect
 * class.
 *
 ...
 * {@link drianmon.spi.impl.JdbcDialectImpl}, to help to make your
 ...
 *
 * @see drianmon.spi.DialectFactory
 * @see drianmon.spi.DialectManager
 *
 * @author jhyde
 * @since Oct 10, 2008
 */
public interface Dialect {
     ...
     * {@link drianmon.spi.Dialect.DatabaseProduct#UNKNOWN} if the database is
     ...
     *
     * @see drianmon.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)
     *
