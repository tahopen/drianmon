...
public abstract class MemberBase
  ...
  /**
   * Cached values of {@link drianmon.olap.Member.MemberType} enumeration. Without caching, get excessive calls to
   * {@link Object#clone}.
   */
  ...
  /**
   * Returns whether this <code>Member</code>'s unique name is equal to, a child of, or a descendent of a member whose
   * unique name is
