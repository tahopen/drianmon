    ...
    implements Cube, Named
{
    ...
    public NamedList<Dimension> getDimensions() {
        ...
        final drianmon.olap.SchemaReader schemaReader =
            ...
            .withLocus();
        for (drianmon.olap.Dimension dimension
    ...
    public List<Measure> getMeasures() {
        ...
        try {
            ...
            List<drianmon.olap.Member> levelMembers =
                schemaReader.getLevelMembers(
                    measuresLevel.level,
                    true);
            for (drianmon.olap.Member member : levelMembers) {
    ...
    public NamedList<NamedSet> getSets() {
        ...
        final MondrianOlap4jConnection olap4jConnection =
            olap4jSchema.olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection;
        for (drianmon.olap.NamedSet namedSet : cube.getNamedSets()) {
    ...
    private MondrianOlap4jMember lookupMember(
        ...
        List<IdentifierSegment> nameParts)
    {
        final List<drianmon.olap.Id.Segment> segmentList =
            new ArrayList<drianmon.olap.Id.Segment>();
