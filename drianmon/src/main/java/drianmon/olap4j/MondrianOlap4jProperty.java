...
class MondrianOlap4jProperty implements IMondrianOlap4jProperty, Named {
    ...
    static {
        ...
        for (drianmon.olap.Property o
            : drianmon.olap.Property.enumeration.getValuesSortedByName())
        {
    ...
    final drianmon.olap.Property property;

    MondrianOlap4jProperty(drianmon.olap.Property property) {
    ...
    MondrianOlap4jProperty
        (drianmon.olap.Property property, drianmon.olap.Level level) {
        this(property);
        this.level = level;
    }
    ...
    public drianmon.olap.Level getLevel() {
        return level;
    }
