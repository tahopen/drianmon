...
import drianmon.olap.fun.FunInfo;
import drianmon.olap.type.TypeUtil;
import drianmon.rolap.RolapConnectionProperties;
...
public class CmdRunner {
    ...
    public Expr parseParameter(String value) {
        ...
        } else if (element instanceof drianmon.olap.Level) {
            drianmon.olap.Level level = (drianmon.olap.Level) element;
...
*/
    ...
    private static void setDefaultCommentState() {
        allowNestedComments = drianmon.olap.Scanner.getNestedCommentsState();
        String[][] scannerCommentsDelimiters =
            drianmon.olap.Scanner.getCommentDelimiters();
