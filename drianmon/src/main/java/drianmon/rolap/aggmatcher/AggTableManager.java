...
import drianmon.recorder.ListRecorder;
import drianmon.recorder.MessageRecorder;
import drianmon.recorder.RecorderException;
 ...
 * <li>A {@link drianmon.rolap.RolapSchema} creates an {@link AggTableManager},
 *     and stores it in a member variable to ensure that it is not
 *     garbage-collected.
 * <li>The {@link drianmon.rolap.RolapSchema} calls {@link #initialize(PropertyList)},
...
*/
     ...
     * {@link drianmon.rolap.aggmatcher.ExplicitRules.Group} in every
