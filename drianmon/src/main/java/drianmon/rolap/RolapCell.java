...
import drianmon.olap.fun.SetFunDef;
...
/**
 * <code>RolapCell</code> implements {@link drianmon.olap.Cell} within a
 * {@link RolapResult}.
 */
public class RolapCell implements Cell {
    /**
     * @see drianmon.util.Bug#olap4jUpgrade Use
     * {@link drianmon.xmla.XmlaConstants}.ActionType.DRILLTHROUGH when present
     */
