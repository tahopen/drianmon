 ...
 * Each call that modifies state (such as {@link drianmon.olap.Evaluator#setContext(drianmon.olap.Member)}) creates, at
...
public class RolapEvaluator implements Evaluator {
  ...
  /**
   * More specific version of {@link #getContext(drianmon.olap.Hierarchy)}, for internal code.
   *
   * @param hierarchy
   *          Hierarchy
   ...
   * @param eval
   *          Evaluator
   * @throws drianmon.olap.fun.MondrianEvaluationException
   *           if there is a loop
   */
