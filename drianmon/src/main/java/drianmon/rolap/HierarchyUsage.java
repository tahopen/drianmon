...
public class HierarchyUsage {
     ...
     * used.
     */
    protected final DrianmonDef.Relation fact;
    ...
    HierarchyUsage(
        ...
        DrianmonDef.CubeDimension cubeDim)
    {
        ...
        if (cubeDim instanceof DrianmonDef.DimensionUsage) {
            ...
            // source
            // level
            DrianmonDef.DimensionUsage du =
                (DrianmonDef.DimensionUsage) cubeDim;
        ...
        } else if (cubeDim instanceof DrianmonDef.Dimension) {
            this.kind = Kind.PRIVATE;

            // Private Hierarchy attributes
            // type
            // caption
            DrianmonDef.Dimension d = (DrianmonDef.Dimension) cubeDim;
        ...
        } else if (cubeDim instanceof DrianmonDef.VirtualCubeDimension) {
            this.kind = Kind.VIRTUAL;

            // Virtual Hierarchy attributes
            DrianmonDef.VirtualCubeDimension vd =
                (DrianmonDef.VirtualCubeDimension) cubeDim;
    ...
    public DrianmonDef.Relation getJoinTable() {
        return this.joinTable;
    }

    public DrianmonDef.Expression getJoinExp() {
        return this.joinExp;
    }
     ...
     */
    private DrianmonDef.Relation findJoinTable(
        RolapHierarchy hierarchy,
        String tableName)
    {
        final DrianmonDef.Relation table;
        if (tableName == null) {
