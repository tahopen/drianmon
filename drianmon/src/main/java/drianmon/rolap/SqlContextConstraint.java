    ...
    implements MemberChildrenConstraint, TupleConstraint
{
    ...
    * methods {@link drianmon.rolap.sql.MemberChildrenConstraint#addMemberConstraint(drianmon.rolap.sql.SqlQuery, drianmon.rolap.RolapCube, drianmon.rolap.aggmatcher.AggStar, RolapMember)} and
    * {@link drianmon.rolap.sql.MemberChildrenConstraint#addMemberConstraint(drianmon.rolap.sql.SqlQuery, drianmon.rolap.RolapCube, drianmon.rolap.aggmatcher.AggStar, java.util.List)} will
