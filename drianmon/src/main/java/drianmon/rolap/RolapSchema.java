...
import drianmon.rolap.aggmatcher.AggTableManager;
import drianmon.spi.*;
...
public class RolapSchema implements Schema {
     ...
     * that has
     * {@link drianmon.rolap.RolapConnectionProperties#Ignore Ignore}=true.
     */
  ...
  @Deprecated
     ...
     * (see {@link drianmon.rolap.RolapConnectionProperties#Ignore}), adds
     ...
     *   The class must implement {@link drianmon.spi.UserDefinedFunction}
