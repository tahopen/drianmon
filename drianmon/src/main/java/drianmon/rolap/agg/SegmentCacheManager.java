...
import drianmon.olap.CacheControl.CellRegion;
import drianmon.rolap.CacheControlImpl;
import drianmon.rolap.RolapSchema;
import drianmon.rolap.RolapStar;
import drianmon.rolap.RolapStoredMeasure;
import drianmon.rolap.RolapUtil;
import drianmon.rolap.SchemaKey;
import drianmon.rolap.cache.MemorySegmentCache;
import drianmon.rolap.cache.SegmentCacheIndex;
import drianmon.rolap.cache.SegmentCacheIndexImpl;
import drianmon.server.Execution;
import drianmon.server.Locus;
import drianmon.server.monitor.CellCacheEvent;
import drianmon.server.monitor.CellCacheSegmentCreateEvent;
import drianmon.server.monitor.CellCacheSegmentDeleteEvent;
import drianmon.server.monitor.Monitor;
import drianmon.spi.SegmentBody;
import drianmon.spi.SegmentCache;
import drianmon.spi.SegmentColumn;
import drianmon.spi.SegmentHeader;
 ...
 * and "external cache" (as implemented by a {@link drianmon.spi.SegmentCache}.
 *
 * <p>Segment states</p>
 *
 * <table>
 ...
 *
 * <p>3. Delete {@link drianmon.rolap.RolapStar#lookupOrCreateAggregation}
 * and {@link drianmon.rolap.RolapStar#lookupSegment}
 * and {@link drianmon.rolap.RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link drianmon.rolap.RolapStar#getCellFromCache} moved from
 ...
 *
 * <p>8. Longer term. Move {@link drianmon.rolap.RolapStar.Bar}.segmentRefs to
 * {@link drianmon.server.Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link drianmon.spi.DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link drianmon.rolap.agg.SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link drianmon.rolap.agg.SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link drianmon.util.CombiningGenerator}.</p>
 *
 * <p>22. {@link SegmentHeader#constrain(drianmon.spi.SegmentColumn[])} is
...
public class SegmentCacheManager {
  ...
  /**
   * Copy-pasted from {@link drianmon.server.monitor.Monitor}. Consider abstracting common code.
   */
