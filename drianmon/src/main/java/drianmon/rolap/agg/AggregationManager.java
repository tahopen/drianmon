...
import drianmon.rolap.SqlStatement.Type;
...
public class AggregationManager extends RolapAggregationManager {
     ...
     *   Use {@link drianmon.olap.MondrianServer#getAggregationManager()}.
     *   To get a server, call
     *   {@link drianmon.olap.MondrianServer#forConnection(drianmon.olap.Connection)},
...
*/
    ...
    /**
     * Implementation of {@link drianmon.rolap.RolapAggregationManager.PinSet}
