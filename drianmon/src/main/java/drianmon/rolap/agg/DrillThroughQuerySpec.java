...
import drianmon.rolap.RolapStar.Measure;
...
class DrillThroughQuerySpec extends AbstractQuerySpec {
        ...
        final Set<String> columnNameSet)
    {
        ...
        if (columnName != null) {
            // nothing
        } else if (column.getExpression() instanceof DrianmonDef.Column) {
            columnName = ((DrianmonDef.Column) column.getExpression()).name;
        } else {
