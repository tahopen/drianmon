 ...
 *
 * <p>
 * To read timing information, add a handler to the statement using {@link drianmon.server.Statement#enableProfiling}
 * and implement the {@link drianmon.spi.ProfileHandler#explain(String, QueryTiming)} method.
 *
 * @author jbarnett
 */
