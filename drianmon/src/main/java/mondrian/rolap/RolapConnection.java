 ...
 * {@link DriverManager#getConnection(String, drianmon.spi.CatalogLocator)}.
...
public class RolapConnection extends ConnectionBase {
  ...
  /**
   * Returns the instance of the {@link drianmon.spi.DataSourceResolver}
   * plugin.
   *
   ...
   * {@link drianmon.olap.Util.PropertyList connectInfo}.
   *
   ...
   *                                        the property file
   * @deprecated Use {@link #execute(drianmon.server.Execution)}; this method
