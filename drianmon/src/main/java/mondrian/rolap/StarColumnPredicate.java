...
public interface StarColumnPredicate extends StarPredicate {
     ...
     * {@link drianmon.util.Bug#BugMondrian313Fixed bug MONDRIAN-313} and
     * {@link drianmon.util.Bug#BugMondrian314Fixed bug MONDRIAN-314} are fixed.
     */
    StarColumnPredicate cloneWithColumn(RolapStar.Column column);

    /**
     * Returned by
     * {@link drianmon.rolap.StarColumnPredicate#intersect},
